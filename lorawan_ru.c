...
/****************************** VARIABLES *************************************/
const uint8_t rxWindowSize[] =  {8, 10, 14, 26, 49, 88, 60, 8}; //original
//const uint8_t rxWindowSize[] =  {16, 16, 16, 16, 16, 16, 16, 32};
...
const int8_t rxWindowOffset[] = {-33, -50, -58, -62, -66, -68, -15, -2}; //original
//const int8_t rxWindowOffset[] = {-258, -131, -65, -32, -16, -29, -8, -4};
