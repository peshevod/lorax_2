...
_par_t _pars[]={
    ...
    {PAR_UI8,"Sensor1",{ 0x05 }, "JP4 mode: 0x01 bit 1-enabled 0-disabled, 0x02 bit 1-ack required 0-only note, 0x04 bit: if set= 1-alarm 0-norm",VISIBLE },
    {PAR_UI8,"Sensor2",{ 0x05 }, "JP5 mode: 0x01 bit 1-enabled 0-disabled, 0x02 bit 1-ack required 0-only note, 0x04 bit: if set= 1-alarm 0-norm",VISIBLE },
